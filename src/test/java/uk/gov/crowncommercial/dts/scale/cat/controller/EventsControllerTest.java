...
//        .andExpect(content().contentType(APPLICATION_JSON));
  ...
  void shouldGetUseQuestionGroup_Answer_True() throws Exception {
    ...
    mockMvc
      .perform(get(EVENTS_PATH + "/{eventID}/usequestiongroups/{groupType}", PROC_PROJECT_ID, EVENT_ID, GROUP_TYPE)
        .with(validJwtReqPostProcessor).accept(APPLICATION_JSON))
      .andDo(print())
      .andExpect(status().isOk())
  ...
  void shouldGetUseQuestionGroup_Answer_Null_ForNullGroupType() throws Exception {
    ...
    mockMvc
      .perform(get(EVENTS_PATH + "/{eventID}/usequestiongroups/{groupType}", PROC_PROJECT_ID, EVENT_ID, nullGroupType)
        .with(validJwtReqPostProcessor).accept(APPLICATION_JSON))
      .andDo(print())
  ...
  void shouldSaveUseQuestionGroup_AnswerTrue() throws Exception {
    ...
    mockMvc
    .perform(post(EVENTS_PATH + "/{eventID}/usequestiongroups/{groupType}", PROC_PROJECT_ID, EVENT_ID, GROUP_TYPE)
      .with(validJwtReqPostProcessor).accept(APPLICATION_JSON)
      .contentType(MediaType.APPLICATION_JSON)
  ...
  void shouldFailToSaveUseQuestionGroup_NoGroupType() throws Exception {
    ...
    mockMvc
    .perform(post(EVENTS_PATH + "/{eventID}/usequestiongroups/{groupType}", PROC_PROJECT_ID, EVENT_ID, "")
      .with(validJwtReqPostProcessor).accept(APPLICATION_JSON)
      .contentType(MediaType.APPLICATION_JSON)
      .content(objectMapper.writeValueAsString(useQuestionGroups)))
    .andDo(print())
  ...
  void shouldGetQuestionGroups() throws Exception {
    ...
    mockMvc
      .perform(get(EVENTS_PATH + "/{eventID}/questiongroups/{groupType}", PROC_PROJECT_ID, EVENT_ID, GROUP_TYPE)
        .with(validJwtReqPostProcessor).accept(APPLICATION_JSON))
      .andDo(print())
      .andExpect(status().isOk())
  ...
  void shouldGetQuestionGroup_Answer_Null_ForNullGroupType() throws Exception {
    ...
    mockMvc
      .perform(get(EVENTS_PATH + "/{eventID}/questiongroups/{groupType}", PROC_PROJECT_ID, EVENT_ID, nullGroupType)
        .with(validJwtReqPostProcessor).accept(APPLICATION_JSON))
      .andDo(print())
      .andExpect(status().is5xxServerError())
      .andExpect(content().string(not(containsString("questionGroups"))))
  ...
  void shouldSaveQuestionGroup() throws Exception {
    ...
    mockMvc
    .perform(post(EVENTS_PATH + "/{eventID}/questiongroups/{groupType}?deleteExisting=true", PROC_PROJECT_ID, EVENT_ID, GROUP_TYPE)
      .with(validJwtReqPostProcessor).accept(APPLICATION_JSON)
      .contentType(MediaType.APPLICATION_JSON)
  ...
  void shouldSaveQuestionGroup_dontDelete() throws Exception {
    ...
    mockMvc
    .perform(post(EVENTS_PATH + "/{eventID}/questiongroups/{groupType}", PROC_PROJECT_ID, EVENT_ID, GROUP_TYPE)
      .with(validJwtReqPostProcessor).accept(APPLICATION_JSON)
      .contentType(MediaType.APPLICATION_JSON)
      .content(objectMapper.writeValueAsString(request)))
    .andDo(print())
  ...
  void shouldNotSaveQuestionGroup_NoQuestionGroup() throws Exception {
    ...
    mockMvc
    .perform(post(EVENTS_PATH + "/{eventID}/questiongroups/{groupType}", PROC_PROJECT_ID, EVENT_ID, nullGroupType)
      .with(validJwtReqPostProcessor).accept(APPLICATION_JSON)
      .contentType(MediaType.APPLICATION_JSON)
      .content(objectMapper.writeValueAsString(new QuestionGroupNamesWrite())))
    .andDo(print())
