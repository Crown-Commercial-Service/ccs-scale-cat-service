...
public class Constants {
    ...
    public static final MediaType MEDIA_TYPE_ODT = MediaType.parseMediaType("application/vnd.oasis.opendocument.text");
    ...
    public static final Set<DefineEventType> ASSESSMENT_EVENT_TYPES = Set.of(DefineEventType.FC, DefineEventType.FCA, DefineEventType.DA, DefineEventType.DAA, DefineEventType.PA, DefineEventType.SAS, DefineEventType.MS1, DefineEventType.MSR);
    public static final Set<DefineEventType> DATA_TEMPLATE_EVENT_TYPES = Set.of(DefineEventType.RFI, DefineEventType.EOI, DefineEventType.FC, DefineEventType.MS1, DefineEventType.MSR);
    ...
    public static final Set<ViewEventType> NOT_ALLOWED_EVENTS_AFTER_AWARD = Set.of(ViewEventType.FC, ViewEventType.DA, ViewEventType.EOI, ViewEventType.RFI, ViewEventType.MSR);
    public static final Set<ViewEventType> TENDER_NON_DB_EVENT_TYPES = Set.of(ViewEventType.EOI, ViewEventType.RFI, ViewEventType.FC, ViewEventType.DA, ViewEventType.MS1, ViewEventType.MSR);
    ...
    public static final Set<ViewEventType> FC_DA_NON_COMPLETE_EVENT_TYPES = Set.of(ViewEventType.FC, ViewEventType.DA, ViewEventType.MS1, ViewEventType.MSR);
    ...
    public static final List<String> CLOSED_STATUS_LIST = Arrays.asList(CLOSED_STATUS.toLowerCase(), TerminationType.CANCELLED.getValue(),TerminationType.WITHDRAWN.getValue(), TerminationType.UNSUCCESSFUL.getValue(), COMPLETE_STATUS.toLowerCase());
