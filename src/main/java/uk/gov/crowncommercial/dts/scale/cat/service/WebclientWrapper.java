...
public class WebclientWrapper {
	...
	public <T> Optional<T> getOptionalResource(final Class<T> resourceType, final WebClient webclient,
		...
		Function<WebClientResponseException, Mono<T>> funcFallback404 = ex -> ex.getRawStatusCode() == 404
				? Mono.empty()
				: Mono.error(ex);
	...
	/**
	 * Uses the passed webclient, uri template ,token and optional params to post
	 * the given data to the remote service
	 * 
	 * @param <T>
	 * @param postData
	 * @param responseType
