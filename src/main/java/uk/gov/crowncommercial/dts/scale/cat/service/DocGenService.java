                ...
                if (docTemplates != null && !docTemplates.isEmpty()) {
                    ...
                    for (DocumentTemplate template : filteredDocTemplates) {
                        if (isMultiStage) {
                            ...
                            try {
                                List<DocumentAttachment> attachments = generateDocumentForMultiStage(procurementEvent, template);

                                if (attachments != null && !attachments.isEmpty()) {
                                    for (DocumentAttachment attachment : attachments) {
                                        if (attachment.getData() != null) {
                                            // Upload directly using the dynamic filename generated by the multi-stage engine
                                            ...
                                            jaggaerService.eventUploadDocument(procurementEvent, attachment.getFileName(), fileDescription, SUPPLIER, multipartFile);
                                        }
                                    }
                                }
                            } catch (Exception ex) {
