...
cf push --var route-prefix=$CF_ROUTE_PREFIX --var memory=$CF_MEMORY --var agreements-service-url=$AGREEMENTS_SERVICE_URL --var agreements-svc-api-key=TBC --var ROLLBAR_ACCESS_TOKEN=$ROLLBAR_ACCESS_TOKEN